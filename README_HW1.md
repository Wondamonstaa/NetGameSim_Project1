...
В данной секции будет приведено подробноеописание каждого из классов, которые я импементировал в данном проекте, а также обоснование использования того или иного класса при планировании и разработки дизайна алгоритма для подсчета схожестей в сгенерированных графиках: 
